...
export const loader = async ({request, params}) => {
    ...
    return json(await getCentersByResultId({resultId, sort, url: "/high"}))
}
...
export async function action({ request, params }) {
    ...
    switch (action) {
        case "pagination": {
            return json(await getCentersByResultId({resultId, page, sort, url: "/high"}));
        }
        case "search": {
            return json(await searchCenters({resultId, value, sort, url: "/high"}));
        }
        default:
            return json({});
    }
...
export default function HighResultsResultIdCenters_index() {
