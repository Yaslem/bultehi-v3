...
export const loader = async ({params}) => {
    ...
    return json(({
        center: await getCenterById({centerId, url: "/middle/results"}),
        results: await getTopStudentsByCenterId({centerId, resultId, url: "/middle/results"})
    }))
}
...
export async function action({ request, params }) {
    ...
    switch (action) {
        case "search": {
            ...
            const isTitle = true
            return json(await getResultStudent({page, resultId, target, value, isTitle, searchBy, searchById: centerId, url: "/middle/results"}));
        }
        default:
            return json({})
    }
...
export default function MiddleResultsResultIdCentersCenterId_index() {
