...
export const loader = async ({params}) => {
    ...
    return json(({
        school: await getSchoolById({schoolId, url: "/middle/results"}),
        results: await getTopStudentsBySchoolId({schoolId, resultId, url: "/middle/results"})
    }))
}
...
export async function action({ request, params }) {
    ...
    switch (action) {
        case "search": {
            ...
            const isTitle = true
            return json(await getResultStudent({page, resultId, target, value, isTitle, searchBy, searchById: schoolId, url: "/high/results"}));
        }
        default:
            return json({})
    }
...
export default function MiddleResultsResultIdSchoolsSchoolId_index() {
